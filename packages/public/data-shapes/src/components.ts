...
export type Component = MarkdownComponent | CollectionComponent | CollectionGroupComponent | CollectionItemComponent | CollectionItemMetadataComponent
...
export const testComponent = {
    ...
    content: "An ALTERED Component for testing.",

    type: "component",

    componentId: "markdown",
    componentContent: "# Test"
} satisfies Component
