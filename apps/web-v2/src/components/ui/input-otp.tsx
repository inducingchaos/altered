...
// biome-ignore lint/performance/noNamespaceImport: Third-party code. Preserving functionality - fix later.
...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
    return (
        // biome-ignore lint/a11y/useFocusableInteractive: Third-party code. Preserving functionality - fix later.
        // biome-ignore lint/a11y/useSemanticElements: Third-party code. Preserving functionality - fix later.
        <div
            className="flex items-center [&_svg:not([class*='size-'])]:size-4"
            data-slot="input-otp-separator"
            // biome-ignore lint/a11y/useAriaPropsForRole: Third-party code. Preserving functionality - fix later.
            role="separator"
            {...props}
        >
            <IconMinus />
