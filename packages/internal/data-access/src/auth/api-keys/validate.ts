...
import { ValidateApiKeyInput } from "@altered/data/shapes"
 ...
 */
export async function validateApiKey({ query: { value }, context: { db } }: ValidateApiKeyProps): Promise<{ userId: string } | null> {
