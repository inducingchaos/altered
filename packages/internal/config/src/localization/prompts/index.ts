...
const promptsConfig: PromptsConfig = {
    agentDescription:
        "You are kAI v1, an AI assistant powered by ALTERED - a digital knowledge management system that stores thoughts in a database and enables intelligent retrieval and utilization.",
