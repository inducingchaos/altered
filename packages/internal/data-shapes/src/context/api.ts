...
export type APIContext = APIInitialContext &
    Partial<APIDatabaseContext & APIAuthContext & APIAppContext>

export type RouteFactoryContext = APIDatabaseContext
export type AuthenticatedRouteFactoryContext = RouteFactoryContext &
    APIAuthContext
export type EnrichedRouteFactoryContext = AuthenticatedRouteFactoryContext &
    APIAppContext
