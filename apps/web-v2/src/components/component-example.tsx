    ...
    return (
        <Example className="items-center justify-center" title="Card">
            <Card className="relative w-full max-w-sm overflow-hidden pt-0">
                ...
                {/** biome-ignore lint/correctness/useImageSize: Third-party code - preserve functionality. */}
                {/** biome-ignore lint/performance/noImgElement: Third-party code - preserve functionality. */}
                <img
                    // biome-ignore lint/a11y/noRedundantAlt: Third-party code - preserve functionality.
