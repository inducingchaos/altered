...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            className={cn(
                "group/calendar bg-background p-2 [--cell-size:--spacing(7)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
            ...
            components={{
                // biome-ignore lint/correctness/noNestedComponentDefinitions: Third-party code. Preserving functionality - fix later.
