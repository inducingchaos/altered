...
function SidebarProvider({
    ...
    const setOpen = React.useCallback(
        (value: boolean | ((value: boolean) => boolean)) => {
            ...
            // biome-ignore lint/suspicious/noDocumentCookie: Third-party code. Preserving functionality - fix later.
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: Third-party code. Preserving functionality - fix later.
