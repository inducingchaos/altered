...
export type LoggerPluginOptions<PluginOptions extends Record<string, unknown> = Record<string, unknown>> = PluginOptions
export type LoggerPluginProps<PluginOptions extends LoggerPluginOptions = LoggerPluginOptions, Hydrated extends boolean = false> = {
    logOptions?: LogOptions
    logType: ConsoleLogType
    loggerConfig: LoggerConfig
} & (Hydrated extends true ? Record<string, unknown> : { pluginOptions: PluginOptions })
 ...
 */
export type LoggerPluginHandlerResult = void

export type LoggerPluginHandler<PluginOptions extends LoggerPluginOptions = LoggerPluginOptions, Hydrated extends boolean = false> = (options: LoggerPluginProps<PluginOptions, Hydrated>) => LoggerPluginHandlerResult

export type LoggerPlugin<PluginOptions extends LoggerPluginOptions = LoggerPluginOptions, Hydrated extends boolean = false> = {
    id: string
    handle: LoggerPluginHandler<PluginOptions, Hydrated>
}

export type LoggerPluginFactoryResult<PluginOptions extends LoggerPluginOptions = LoggerPluginOptions> = LoggerPlugin<PluginOptions, true> | null
 ...
 */
export type LoggerPluginFactory<PluginOptions extends LoggerPluginOptions = LoggerPluginOptions> = (options?: PluginOptions) => LoggerPluginFactoryResult
